...
| `hasWrappers`  | Optional: Whether the analyses have "wrappers" generated for thm, which means they are usable with syntax mode.                                                                                                                                 |
| `alwaysSaveState`  | Optional: Overrides whether the state and plot objects are always saved, ignoring the user preference.   |
| `preloadData`  | Optional: Overrides whether the state and plot objects are never saved, ignoring the user preference.              |
